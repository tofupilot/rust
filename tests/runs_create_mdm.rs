                ...
                .y_axis(vec![RunCreateYAxis::builder()
                    ...
                    .validators(vec![
                        RunCreateYAxisValidators::builder()
                            .operator(">=")
                            .expected_value(serde_json::json!(2.5))
                            .outcome("PASS")
                            .build()
                            .unwrap(),
                        RunCreateYAxisValidators::builder()
                            .operator("<=")
                            .expected_value(serde_json::json!(4.0))
                            .outcome("PASS")
                            .build()
                            .unwrap(),
                    ])
        ...
        .phases(vec![RunCreatePhases::builder()
            ...
            .measurements(vec![RunCreateMeasurements::builder()
                ...
                .y_axis(vec![RunCreateYAxis::builder()
                    ...
                    .units("%")
                    .description("Quality")
                    .aggregations(vec![RunCreateYAxisAggregations::builder()
                        .r#type("avg")
                        .value(serde_json::json!(95.17))
                        .outcome("PASS")
                        .validators(vec![RunCreateYAxisAggregationsValidators::builder()
                            .operator(">=")
            ...
            .measurements(vec![RunCreateMeasurements::builder()
                ...
                .x_axis(
                    RunCreateXAxis::builder()
                        ...
                        .units("s")
                        .validators(vec![RunCreateValidators::builder()
                            .operator(">=")
            ...
            .measurements(vec![RunCreateMeasurements::builder()
                ...
                .x_axis(
                    RunCreateXAxis::builder()
                        ...
                        .units("s")
                        .aggregations(vec![RunCreateAggregations::builder()
                            .r#type("max")
            ...
            .measurements(vec![RunCreateMeasurements::builder()
                ...
                .y_axis(vec![
                    RunCreateYAxis::builder()
                        ...
                        .units("dB")
                        .description("Gain")
                        .validators(vec![RunCreateYAxisValidators::builder()
                            .operator(">=")
                            .expected_value(serde_json::json!(-6.0))
                            .outcome("PASS")
                            .build()
                            .unwrap()])
                        .aggregations(vec![RunCreateYAxisAggregations::builder()
