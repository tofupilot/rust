...
| `outcome` | `Option<Outcome>` | :heavy_minus_sign: | Aggregation validation result: PASS, FAIL, UNSET, or null if no validators. |
...
| `validators` | `NullableField<Vec<MeasurementGetDataSeriesAggregationsValidators>>` | :heavy_minus_sign: | Validators applied to the aggregated value. |
